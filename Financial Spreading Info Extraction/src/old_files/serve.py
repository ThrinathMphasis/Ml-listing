...
def upload():
    ...
    try:
        ...
        return flask.Response(response="Give name of the zip file as Input.zip which contain a file named Input: where the .pdf is present ",status=500,mimetype='text/plain')
    ...
    try:
        ...
        return flask.Response(response="Error Log"+str(e),status=500,mimetype='text/plain')
